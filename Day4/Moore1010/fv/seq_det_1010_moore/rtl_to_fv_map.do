...
# Generated on: Mon Mar 30 15:44:25 IST 2026 (Mon Mar 30 10:14:25 UTC 2026)
...
set_log_file fv/seq_det_1010_moore/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/seq_det_1010_moore -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  seq_detect_moore_1010.v
elaborate_design -golden -root {seq_det_1010_moore} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/seq_det_1010_moore/fv_map.v.gz
elaborate_design -revised -root {seq_det_1010_moore}
...
#add_name_alias fv/seq_det_1010_moore/fv_map.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/seq_det_1010_moore/rtl_to_fv_map.log
}
